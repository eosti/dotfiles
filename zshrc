...
alias t='ultralist'							# todolist shortcuts
alias tl='ultralist list by project'			# List all todos by project
alias ta='ultralist add'						# Add a todo
alias tc='ultralist complete'				# Complete a todo
alias td='ultralist ac'						# Delete todos
